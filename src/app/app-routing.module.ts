...
import { ManageNodeModule } from './manage-node/manage-node.module';
...
const routes: Routes = [
  ...
  { path: 'signin', component: PagesLoginComponent },
  { path: 'signup', component: PagesRegisterComponent },
  { path: 'user-profile', component: UsersProfileComponent },
  { path: 'nodedata', component: NodedataComponent},
  {
    path: 'nodes',
    loadChildren: () => ManageNodeModule,
  },
];
